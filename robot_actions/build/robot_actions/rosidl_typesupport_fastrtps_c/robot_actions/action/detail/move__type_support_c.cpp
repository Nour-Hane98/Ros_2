...
#include "robot_actions/action/detail/move__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // motion_type
#include "rosidl_runtime_c/string_functions.h"  // motion_type

// forward declare type support functions


using _Move_Goal__ros_msg_type = robot_actions__action__Move_Goal;
...
size_t get_serialized_size_robot_actions__action__Move_Goal(
  const void * untyped_ros_message,
...
static uint32_t _Move_Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_actions__action__Move_Goal(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_actions
size_t max_serialized_size_robot_actions__action__Move_Goal(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_actions__action__Move_Goal;
    is_plain =
      (
...
static size_t _Move_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_actions__action__Move_Goal(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_actions, action, Move_Goal)() {
...
using _Move_Result__ros_msg_type = robot_actions__action__Move_Result;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_actions
size_t get_serialized_size_robot_actions__action__Move_Result(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Move_Result__ros_msg_type * ros_message = static_cast<const _Move_Result__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_actions__action__Move_Result(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_actions
size_t max_serialized_size_robot_actions__action__Move_Result(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robot_actions__action__Move_Result;
    is_plain =
      (
...
static size_t _Move_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_actions__action__Move_Result(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_actions, action, Move_Result)() {
...
using _Move_Feedback__ros_msg_type = robot_actions__action__Move_Feedback;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_actions
size_t get_serialized_size_robot_actions__action__Move_Feedback(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Move_Feedback__ros_msg_type * ros_message = static_cast<const _Move_Feedback__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_actions__action__Move_Feedback(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_actions
size_t max_serialized_size_robot_actions__action__Move_Feedback(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robot_actions__action__Move_Feedback;
    is_plain =
      (
...
static size_t _Move_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_actions__action__Move_Feedback(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_actions, action, Move_Feedback)() {
...
// already included above
// #include "robot_actions/action/detail/move__functions.h"  // goal
...
using _Move_SendGoal_Request__ros_msg_type = robot_actions__action__Move_SendGoal_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, robot_actions, action, Move_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_actions
size_t get_serialized_size_robot_actions__action__Move_SendGoal_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Move_SendGoal_Request__ros_msg_type * ros_message = static_cast<const _Move_SendGoal_Request__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_robot_actions__action__Move_Goal(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_actions__action__Move_SendGoal_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_actions
size_t max_serialized_size_robot_actions__action__Move_SendGoal_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_robot_actions__action__Move_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robot_actions__action__Move_SendGoal_Request;
    is_plain =
      (
...
static size_t _Move_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_actions__action__Move_SendGoal_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_actions, action, Move_SendGoal_Request)() {
...
using _Move_SendGoal_Response__ros_msg_type = robot_actions__action__Move_SendGoal_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_actions
size_t get_serialized_size_robot_actions__action__Move_SendGoal_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Move_SendGoal_Response__ros_msg_type * ros_message = static_cast<const _Move_SendGoal_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_actions__action__Move_SendGoal_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_actions
size_t max_serialized_size_robot_actions__action__Move_SendGoal_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robot_actions__action__Move_SendGoal_Response;
    is_plain =
      (
...
static size_t _Move_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_actions__action__Move_SendGoal_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_actions, action, Move_SendGoal_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_actions, action, Move_SendGoal)() {
...
using _Move_GetResult_Request__ros_msg_type = robot_actions__action__Move_GetResult_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_actions
size_t get_serialized_size_robot_actions__action__Move_GetResult_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Move_GetResult_Request__ros_msg_type * ros_message = static_cast<const _Move_GetResult_Request__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_actions__action__Move_GetResult_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_actions
size_t max_serialized_size_robot_actions__action__Move_GetResult_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robot_actions__action__Move_GetResult_Request;
    is_plain =
      (
...
static size_t _Move_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_actions__action__Move_GetResult_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_actions, action, Move_GetResult_Request)() {
...
// already included above
// #include "robot_actions/action/detail/move__functions.h"  // result
...
using _Move_GetResult_Response__ros_msg_type = robot_actions__action__Move_GetResult_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, robot_actions, action, Move_Result
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_actions
size_t get_serialized_size_robot_actions__action__Move_GetResult_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Move_GetResult_Response__ros_msg_type * ros_message = static_cast<const _Move_GetResult_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_robot_actions__action__Move_Result(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_actions__action__Move_GetResult_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_actions
size_t max_serialized_size_robot_actions__action__Move_GetResult_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_robot_actions__action__Move_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robot_actions__action__Move_GetResult_Response;
    is_plain =
      (
...
static size_t _Move_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_actions__action__Move_GetResult_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_actions, action, Move_GetResult_Response)() {
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_actions, action, Move_GetResult)() {
...
// already included above
// #include "robot_actions/action/detail/move__functions.h"  // feedback
// already included above
// #include "unique_identifier_msgs/msg/detail/uuid__functions.h"  // goal_id
...
using _Move_FeedbackMessage__ros_msg_type = robot_actions__action__Move_FeedbackMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, robot_actions, action, Move_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_actions
size_t get_serialized_size_robot_actions__action__Move_FeedbackMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Move_FeedbackMessage__ros_msg_type * ros_message = static_cast<const _Move_FeedbackMessage__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_robot_actions__action__Move_Feedback(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_actions__action__Move_FeedbackMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_actions
size_t max_serialized_size_robot_actions__action__Move_FeedbackMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_robot_actions__action__Move_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robot_actions__action__Move_FeedbackMessage;
    is_plain =
      (
...
static size_t _Move_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_actions__action__Move_FeedbackMessage(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_actions, action, Move_FeedbackMessage)() {
