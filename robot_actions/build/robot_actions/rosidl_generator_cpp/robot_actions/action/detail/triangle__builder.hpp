...
class Init_Triangle_Feedback_current_step
{
public:
  Init_Triangle_Feedback_current_step()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::robot_actions::action::Triangle_Feedback current_step(::robot_actions::action::Triangle_Feedback::_current_step_type arg)
  {
...
{
  return robot_actions::action::builder::Init_Triangle_Feedback_current_step();
}
