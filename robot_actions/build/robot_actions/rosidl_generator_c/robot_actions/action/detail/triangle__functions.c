...
robot_actions__action__Triangle_Goal__create()
{
  ...
  robot_actions__action__Triangle_Goal * msg = (robot_actions__action__Triangle_Goal *)allocator.allocate(sizeof(robot_actions__action__Triangle_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(robot_actions__action__Triangle_Goal));
  bool success = robot_actions__action__Triangle_Goal__init(msg);
  if (!success) {
...
robot_actions__action__Triangle_Goal__destroy(robot_actions__action__Triangle_Goal * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    robot_actions__action__Triangle_Goal__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
robot_actions__action__Triangle_Goal__Sequence__init(robot_actions__action__Triangle_Goal__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robot_actions__action__Triangle_Goal * data = NULL;

  if (size) {
    data = (robot_actions__action__Triangle_Goal *)allocator.zero_allocate(size, sizeof(robot_actions__action__Triangle_Goal), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = robot_actions__action__Triangle_Goal__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        robot_actions__action__Triangle_Goal__fini(&data[i - 1]);
      }
...
robot_actions__action__Triangle_Goal__Sequence__fini(robot_actions__action__Triangle_Goal__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      robot_actions__action__Triangle_Goal__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robot_actions__action__Triangle_Goal__Sequence * array = (robot_actions__action__Triangle_Goal__Sequence *)allocator.allocate(sizeof(robot_actions__action__Triangle_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = robot_actions__action__Triangle_Goal__Sequence__init(array, size);
  if (!success) {
...
robot_actions__action__Triangle_Goal__Sequence__destroy(robot_actions__action__Triangle_Goal__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    robot_actions__action__Triangle_Goal__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
robot_actions__action__Triangle_Goal__Sequence__are_equal(const robot_actions__action__Triangle_Goal__Sequence * lhs, const robot_actions__action__Triangle_Goal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!robot_actions__action__Triangle_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  robot_actions__action__Triangle_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(robot_actions__action__Triangle_Goal);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    robot_actions__action__Triangle_Goal * data =
      (robot_actions__action__Triangle_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!robot_actions__action__Triangle_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          robot_actions__action__Triangle_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!robot_actions__action__Triangle_Goal__copy(
...
robot_actions__action__Triangle_Result__init(robot_actions__action__Triangle_Result * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->message)) {
    robot_actions__action__Triangle_Result__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robot_actions__action__Triangle_Result * msg = (robot_actions__action__Triangle_Result *)allocator.allocate(sizeof(robot_actions__action__Triangle_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(robot_actions__action__Triangle_Result));
  bool success = robot_actions__action__Triangle_Result__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
robot_actions__action__Triangle_Result__Sequence__init(robot_actions__action__Triangle_Result__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robot_actions__action__Triangle_Result * data = NULL;

  if (size) {
    data = (robot_actions__action__Triangle_Result *)allocator.zero_allocate(size, sizeof(robot_actions__action__Triangle_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = robot_actions__action__Triangle_Result__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        robot_actions__action__Triangle_Result__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
robot_actions__action__Triangle_Result__Sequence__fini(robot_actions__action__Triangle_Result__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      robot_actions__action__Triangle_Result__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robot_actions__action__Triangle_Result__Sequence * array = (robot_actions__action__Triangle_Result__Sequence *)allocator.allocate(sizeof(robot_actions__action__Triangle_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = robot_actions__action__Triangle_Result__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
robot_actions__action__Triangle_Result__Sequence__destroy(robot_actions__action__Triangle_Result__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    robot_actions__action__Triangle_Result__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
robot_actions__action__Triangle_Result__Sequence__are_equal(const robot_actions__action__Triangle_Result__Sequence * lhs, const robot_actions__action__Triangle_Result__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!robot_actions__action__Triangle_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  robot_actions__action__Triangle_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(robot_actions__action__Triangle_Result);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    robot_actions__action__Triangle_Result * data =
      (robot_actions__action__Triangle_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!robot_actions__action__Triangle_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          robot_actions__action__Triangle_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!robot_actions__action__Triangle_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robot_actions__action__Triangle_Feedback * msg = (robot_actions__action__Triangle_Feedback *)allocator.allocate(sizeof(robot_actions__action__Triangle_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(robot_actions__action__Triangle_Feedback));
  bool success = robot_actions__action__Triangle_Feedback__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
robot_actions__action__Triangle_Feedback__destroy(robot_actions__action__Triangle_Feedback * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    robot_actions__action__Triangle_Feedback__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
robot_actions__action__Triangle_Feedback__Sequence__init(robot_actions__action__Triangle_Feedback__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robot_actions__action__Triangle_Feedback * data = NULL;

  if (size) {
    data = (robot_actions__action__Triangle_Feedback *)allocator.zero_allocate(size, sizeof(robot_actions__action__Triangle_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = robot_actions__action__Triangle_Feedback__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        robot_actions__action__Triangle_Feedback__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
robot_actions__action__Triangle_Feedback__Sequence__fini(robot_actions__action__Triangle_Feedback__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      robot_actions__action__Triangle_Feedback__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robot_actions__action__Triangle_Feedback__Sequence * array = (robot_actions__action__Triangle_Feedback__Sequence *)allocator.allocate(sizeof(robot_actions__action__Triangle_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = robot_actions__action__Triangle_Feedback__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
robot_actions__action__Triangle_Feedback__Sequence__destroy(robot_actions__action__Triangle_Feedback__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    robot_actions__action__Triangle_Feedback__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
robot_actions__action__Triangle_Feedback__Sequence__are_equal(const robot_actions__action__Triangle_Feedback__Sequence * lhs, const robot_actions__action__Triangle_Feedback__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!robot_actions__action__Triangle_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  robot_actions__action__Triangle_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(robot_actions__action__Triangle_Feedback);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    robot_actions__action__Triangle_Feedback * data =
      (robot_actions__action__Triangle_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!robot_actions__action__Triangle_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          robot_actions__action__Triangle_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!robot_actions__action__Triangle_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
robot_actions__action__Triangle_SendGoal_Request__init(robot_actions__action__Triangle_SendGoal_Request * msg)
{
  ...
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    robot_actions__action__Triangle_SendGoal_Request__fini(msg);
    return false;
  }
  // goal
  if (!robot_actions__action__Triangle_Goal__init(&msg->goal)) {
    robot_actions__action__Triangle_SendGoal_Request__fini(msg);
    return false;
  }
  return true;
...
robot_actions__action__Triangle_SendGoal_Request__fini(robot_actions__action__Triangle_SendGoal_Request * msg)
{
  ...
  // goal
  robot_actions__action__Triangle_Goal__fini(&msg->goal);
}
...
robot_actions__action__Triangle_SendGoal_Request__are_equal(const robot_actions__action__Triangle_SendGoal_Request * lhs, const robot_actions__action__Triangle_SendGoal_Request * rhs)
{
  ...
  // goal
  if (!robot_actions__action__Triangle_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robot_actions__action__Triangle_SendGoal_Request * msg = (robot_actions__action__Triangle_SendGoal_Request *)allocator.allocate(sizeof(robot_actions__action__Triangle_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(robot_actions__action__Triangle_SendGoal_Request));
  bool success = robot_actions__action__Triangle_SendGoal_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
robot_actions__action__Triangle_SendGoal_Request__Sequence__init(robot_actions__action__Triangle_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robot_actions__action__Triangle_SendGoal_Request * data = NULL;

  if (size) {
    data = (robot_actions__action__Triangle_SendGoal_Request *)allocator.zero_allocate(size, sizeof(robot_actions__action__Triangle_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = robot_actions__action__Triangle_SendGoal_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        robot_actions__action__Triangle_SendGoal_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
robot_actions__action__Triangle_SendGoal_Request__Sequence__fini(robot_actions__action__Triangle_SendGoal_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      robot_actions__action__Triangle_SendGoal_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robot_actions__action__Triangle_SendGoal_Request__Sequence * array = (robot_actions__action__Triangle_SendGoal_Request__Sequence *)allocator.allocate(sizeof(robot_actions__action__Triangle_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = robot_actions__action__Triangle_SendGoal_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
robot_actions__action__Triangle_SendGoal_Request__Sequence__destroy(robot_actions__action__Triangle_SendGoal_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    robot_actions__action__Triangle_SendGoal_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
robot_actions__action__Triangle_SendGoal_Request__Sequence__are_equal(const robot_actions__action__Triangle_SendGoal_Request__Sequence * lhs, const robot_actions__action__Triangle_SendGoal_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!robot_actions__action__Triangle_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  robot_actions__action__Triangle_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(robot_actions__action__Triangle_SendGoal_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    robot_actions__action__Triangle_SendGoal_Request * data =
      (robot_actions__action__Triangle_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!robot_actions__action__Triangle_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          robot_actions__action__Triangle_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!robot_actions__action__Triangle_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
robot_actions__action__Triangle_SendGoal_Response__init(robot_actions__action__Triangle_SendGoal_Response * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    robot_actions__action__Triangle_SendGoal_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robot_actions__action__Triangle_SendGoal_Response * msg = (robot_actions__action__Triangle_SendGoal_Response *)allocator.allocate(sizeof(robot_actions__action__Triangle_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(robot_actions__action__Triangle_SendGoal_Response));
  bool success = robot_actions__action__Triangle_SendGoal_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
robot_actions__action__Triangle_SendGoal_Response__Sequence__init(robot_actions__action__Triangle_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robot_actions__action__Triangle_SendGoal_Response * data = NULL;

  if (size) {
    data = (robot_actions__action__Triangle_SendGoal_Response *)allocator.zero_allocate(size, sizeof(robot_actions__action__Triangle_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = robot_actions__action__Triangle_SendGoal_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        robot_actions__action__Triangle_SendGoal_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
robot_actions__action__Triangle_SendGoal_Response__Sequence__fini(robot_actions__action__Triangle_SendGoal_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      robot_actions__action__Triangle_SendGoal_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robot_actions__action__Triangle_SendGoal_Response__Sequence * array = (robot_actions__action__Triangle_SendGoal_Response__Sequence *)allocator.allocate(sizeof(robot_actions__action__Triangle_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = robot_actions__action__Triangle_SendGoal_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
robot_actions__action__Triangle_SendGoal_Response__Sequence__destroy(robot_actions__action__Triangle_SendGoal_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    robot_actions__action__Triangle_SendGoal_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
robot_actions__action__Triangle_SendGoal_Response__Sequence__are_equal(const robot_actions__action__Triangle_SendGoal_Response__Sequence * lhs, const robot_actions__action__Triangle_SendGoal_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!robot_actions__action__Triangle_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  robot_actions__action__Triangle_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(robot_actions__action__Triangle_SendGoal_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    robot_actions__action__Triangle_SendGoal_Response * data =
      (robot_actions__action__Triangle_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!robot_actions__action__Triangle_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          robot_actions__action__Triangle_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!robot_actions__action__Triangle_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
robot_actions__action__Triangle_GetResult_Request__init(robot_actions__action__Triangle_GetResult_Request * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    robot_actions__action__Triangle_GetResult_Request__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robot_actions__action__Triangle_GetResult_Request * msg = (robot_actions__action__Triangle_GetResult_Request *)allocator.allocate(sizeof(robot_actions__action__Triangle_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(robot_actions__action__Triangle_GetResult_Request));
  bool success = robot_actions__action__Triangle_GetResult_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
robot_actions__action__Triangle_GetResult_Request__Sequence__init(robot_actions__action__Triangle_GetResult_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robot_actions__action__Triangle_GetResult_Request * data = NULL;

  if (size) {
    data = (robot_actions__action__Triangle_GetResult_Request *)allocator.zero_allocate(size, sizeof(robot_actions__action__Triangle_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = robot_actions__action__Triangle_GetResult_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        robot_actions__action__Triangle_GetResult_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
robot_actions__action__Triangle_GetResult_Request__Sequence__fini(robot_actions__action__Triangle_GetResult_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      robot_actions__action__Triangle_GetResult_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robot_actions__action__Triangle_GetResult_Request__Sequence * array = (robot_actions__action__Triangle_GetResult_Request__Sequence *)allocator.allocate(sizeof(robot_actions__action__Triangle_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = robot_actions__action__Triangle_GetResult_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
robot_actions__action__Triangle_GetResult_Request__Sequence__destroy(robot_actions__action__Triangle_GetResult_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    robot_actions__action__Triangle_GetResult_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
robot_actions__action__Triangle_GetResult_Request__Sequence__are_equal(const robot_actions__action__Triangle_GetResult_Request__Sequence * lhs, const robot_actions__action__Triangle_GetResult_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!robot_actions__action__Triangle_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  robot_actions__action__Triangle_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(robot_actions__action__Triangle_GetResult_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    robot_actions__action__Triangle_GetResult_Request * data =
      (robot_actions__action__Triangle_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!robot_actions__action__Triangle_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          robot_actions__action__Triangle_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!robot_actions__action__Triangle_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
robot_actions__action__Triangle_GetResult_Response__init(robot_actions__action__Triangle_GetResult_Response * msg)
{
  ...
  // status
  // result
  if (!robot_actions__action__Triangle_Result__init(&msg->result)) {
    robot_actions__action__Triangle_GetResult_Response__fini(msg);
    return false;
  }
  return true;
}
...
robot_actions__action__Triangle_GetResult_Response__fini(robot_actions__action__Triangle_GetResult_Response * msg)
{
  ...
  // status
  // result
  robot_actions__action__Triangle_Result__fini(&msg->result);
}
...
robot_actions__action__Triangle_GetResult_Response__are_equal(const robot_actions__action__Triangle_GetResult_Response * lhs, const robot_actions__action__Triangle_GetResult_Response * rhs)
{
  ...
  // result
  if (!robot_actions__action__Triangle_Result__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robot_actions__action__Triangle_GetResult_Response * msg = (robot_actions__action__Triangle_GetResult_Response *)allocator.allocate(sizeof(robot_actions__action__Triangle_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(robot_actions__action__Triangle_GetResult_Response));
  bool success = robot_actions__action__Triangle_GetResult_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
robot_actions__action__Triangle_GetResult_Response__Sequence__init(robot_actions__action__Triangle_GetResult_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robot_actions__action__Triangle_GetResult_Response * data = NULL;

  if (size) {
    data = (robot_actions__action__Triangle_GetResult_Response *)allocator.zero_allocate(size, sizeof(robot_actions__action__Triangle_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = robot_actions__action__Triangle_GetResult_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        robot_actions__action__Triangle_GetResult_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
robot_actions__action__Triangle_GetResult_Response__Sequence__fini(robot_actions__action__Triangle_GetResult_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      robot_actions__action__Triangle_GetResult_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robot_actions__action__Triangle_GetResult_Response__Sequence * array = (robot_actions__action__Triangle_GetResult_Response__Sequence *)allocator.allocate(sizeof(robot_actions__action__Triangle_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = robot_actions__action__Triangle_GetResult_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
robot_actions__action__Triangle_GetResult_Response__Sequence__destroy(robot_actions__action__Triangle_GetResult_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    robot_actions__action__Triangle_GetResult_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
robot_actions__action__Triangle_GetResult_Response__Sequence__are_equal(const robot_actions__action__Triangle_GetResult_Response__Sequence * lhs, const robot_actions__action__Triangle_GetResult_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!robot_actions__action__Triangle_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  robot_actions__action__Triangle_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(robot_actions__action__Triangle_GetResult_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    robot_actions__action__Triangle_GetResult_Response * data =
      (robot_actions__action__Triangle_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!robot_actions__action__Triangle_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          robot_actions__action__Triangle_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!robot_actions__action__Triangle_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
robot_actions__action__Triangle_FeedbackMessage__init(robot_actions__action__Triangle_FeedbackMessage * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    robot_actions__action__Triangle_FeedbackMessage__fini(msg);
    return false;
  }
  // feedback
  if (!robot_actions__action__Triangle_Feedback__init(&msg->feedback)) {
    robot_actions__action__Triangle_FeedbackMessage__fini(msg);
    return false;
  }
  return true;
...
robot_actions__action__Triangle_FeedbackMessage__fini(robot_actions__action__Triangle_FeedbackMessage * msg)
{
  ...
  unique_identifier_msgs__msg__UUID__fini(&msg->goal_id);
  // feedback
  robot_actions__action__Triangle_Feedback__fini(&msg->feedback);
}
...
robot_actions__action__Triangle_FeedbackMessage__are_equal(const robot_actions__action__Triangle_FeedbackMessage * lhs, const robot_actions__action__Triangle_FeedbackMessage * rhs)
{
  ...
  // feedback
  if (!robot_actions__action__Triangle_Feedback__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robot_actions__action__Triangle_FeedbackMessage * msg = (robot_actions__action__Triangle_FeedbackMessage *)allocator.allocate(sizeof(robot_actions__action__Triangle_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(robot_actions__action__Triangle_FeedbackMessage));
  bool success = robot_actions__action__Triangle_FeedbackMessage__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
robot_actions__action__Triangle_FeedbackMessage__Sequence__init(robot_actions__action__Triangle_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robot_actions__action__Triangle_FeedbackMessage * data = NULL;

  if (size) {
    data = (robot_actions__action__Triangle_FeedbackMessage *)allocator.zero_allocate(size, sizeof(robot_actions__action__Triangle_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = robot_actions__action__Triangle_FeedbackMessage__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        robot_actions__action__Triangle_FeedbackMessage__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
robot_actions__action__Triangle_FeedbackMessage__Sequence__fini(robot_actions__action__Triangle_FeedbackMessage__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      robot_actions__action__Triangle_FeedbackMessage__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robot_actions__action__Triangle_FeedbackMessage__Sequence * array = (robot_actions__action__Triangle_FeedbackMessage__Sequence *)allocator.allocate(sizeof(robot_actions__action__Triangle_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = robot_actions__action__Triangle_FeedbackMessage__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
robot_actions__action__Triangle_FeedbackMessage__Sequence__destroy(robot_actions__action__Triangle_FeedbackMessage__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    robot_actions__action__Triangle_FeedbackMessage__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
robot_actions__action__Triangle_FeedbackMessage__Sequence__are_equal(const robot_actions__action__Triangle_FeedbackMessage__Sequence * lhs, const robot_actions__action__Triangle_FeedbackMessage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!robot_actions__action__Triangle_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  robot_actions__action__Triangle_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(robot_actions__action__Triangle_FeedbackMessage);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    robot_actions__action__Triangle_FeedbackMessage * data =
      (robot_actions__action__Triangle_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!robot_actions__action__Triangle_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          robot_actions__action__Triangle_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!robot_actions__action__Triangle_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
