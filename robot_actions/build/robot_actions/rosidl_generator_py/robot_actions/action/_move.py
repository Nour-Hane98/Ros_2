    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'robot_actions.action.Move_Goal')
            logger.debug(
...
class Move_Goal(metaclass=Metaclass_Move_Goal):
    ...
    def __init__(self, **kwargs):
        ...
        self.motion_type = kwargs.get('motion_type', str())
    ...
    def motion_type(self, value):
        if __debug__:
            assert \
                ...
                "The 'motion_type' field must be of type 'str'"
...
class Metaclass_Move_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robot_actions.action.Move_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_Move_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robot_actions.action.Move_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Move_SendGoal_Request(metaclass=Metaclass_Move_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'robot_actions/Move_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['robot_actions', 'action'], 'Move_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from robot_actions.action._move import Move_Goal
...
class Metaclass_Move_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robot_actions.action.Move_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from robot_actions.action import _move
...
class Move_SendGoal(metaclass=Metaclass_Move_SendGoal):
    from robot_actions.action._move import Move_SendGoal_Request as Request
    from robot_actions.action._move import Move_SendGoal_Response as Response
...
class Move_GetResult_Response(metaclass=Metaclass_Move_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'robot_actions/Move_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['robot_actions', 'action'], 'Move_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from robot_actions.action._move import Move_Result
...
class Metaclass_Move_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robot_actions.action.Move_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Move_GetResult(metaclass=Metaclass_Move_GetResult):
    from robot_actions.action._move import Move_GetResult_Request as Request
    from robot_actions.action._move import Move_GetResult_Response as Response
...
class Metaclass_Move_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robot_actions.action.Move_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Move_FeedbackMessage(metaclass=Metaclass_Move_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'robot_actions/Move_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['robot_actions', 'action'], 'Move_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from robot_actions.action._move import Move_Feedback
...
class Move(metaclass=Metaclass_Move):
    ...
    from robot_actions.action._move import Move_Goal as Goal
    # The result message defined in the action definition.
    from robot_actions.action._move import Move_Result as Result
    # The feedback message defined in the action definition.
    from robot_actions.action._move import Move_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from robot_actions.action._move import Move_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from robot_actions.action._move import Move_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from robot_actions.action._move import Move_FeedbackMessage as FeedbackMessage
